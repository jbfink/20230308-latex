...
\beamertemplatenavigationsymbolsempty % for eliminating the nav buttons. Handy!
...
\begin{frame}
	\begin{itemize}
		...
		\pause
		\item \LaTeX{} final documents have to be compiled (this presentation takes about 10 seconds on first compile)
		\pause
